    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <form action="{{ route('departments.update', $department) }}" method="POST"
                class="max-w-md mx-auto mt-6 space-y-6">
                @csrf
                @method('PATCH')
                <div>
                    <x-input-label for="title" :value="__('messages.title')" />
                    <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" :value="old('title', $department->title)"
                ...
                <div>
                    ...
                    <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full"
                        :value="old('phone', $department->phone ?? '')" required autofocus autocomplete="phone" id="phone" />
                ...
                <div>
                    ...
                    <x-text-input id="whatsapp" name="whatsapp" type="text" class="mt-1 block w-full"
                        :value="old('whatsapp', $department->whatsapp ?? '')" required autofocus autocomplete="whatsapp" id="whatsapp" />
                ...
                <div>
                    ...
                    <x-text-input id="telegram" name="telegram" type="text" class="mt-1 block w-full"
                        :value="old('telegram', $department->telegram ?? '')" required autofocus autocomplete="telegram" id="telegram" />
                ...
                <div>
                    ...
                    <x-text-input id="email" name="email" type="email" class="mt-1 block w-full"
                        :value="old('email', $department->email ?? '')" required autofocus autocomplete="email" id="email" />
