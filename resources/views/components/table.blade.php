...
@php
    ...
    $action_icons = !empty($action_icons) ? (is_array($action_icons) ? $action_icons : json_decode(str_replace('&quot;', '"', $action_icons), true)) : [];
    $column_aliases = !empty($column_aliases) ? (is_array($column_aliases) ? $column_aliases : json_decode(str_replace('&quot;', '"', $column_aliases), true)) : [];
    $icons_array = [];
