...
<div class="z-20"> {{--max-w-screen overflow-x-hidden md:w-full--}}
    <div class="w-full">
        @if($searchable)
            <div class="table-filter-bar bg-slate-100 p-2">
                <x-input-label name="search-{{$name}}" placeholder="{{$search_placeholder}}"
        ...
        @endif
        <table class="table w-full {{$name}} @if($has_shadow) shadow-2xl shadow-gray-200 dark:shadow-xl dark:shadow-slate-900 @endif
